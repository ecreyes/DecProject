...
module.exports = function(passport) {
    ...
    passport.serializeUser(function(admin, done) {
        console.log("ME SALIO UN ADMIN" +admin.idAdmin);
        done(null, admin.idAdmin);
    });


    passport.deserializeUser(function(idAdmin, done) {
        connection.query("select * from admin where idAdmin = "+idAdmin,function(err,rows){
            done(err, rows[0]);
        });
    });
